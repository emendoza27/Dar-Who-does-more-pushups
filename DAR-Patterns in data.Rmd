...
A study was condocted to see who can do more pushups, line players or skill players. All the players were asked to do as many pushups as they could in two minutes. The players were separated the weight of the players, the amount of pushups done by each player and wether they are line or skill players.

# Results
<!--You have both graphical and numerical methods, so you will have both graphical and numerical results to consider.!-->
According to the results in our data skill players do an average of 55 push more that line players.
...
In this graph we can see skill players do more pushups that line players.
...
Therefore, we can see that the average skill players does 57% more pushup than the average line player, 
